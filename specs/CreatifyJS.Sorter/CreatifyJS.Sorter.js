describe("Sorter", function() {
	...
	describe("Passing an Array of objects and a sort by string", function () {
		var unsorted = [
		...
		it("Returns the Array of objects sorted by by the value of the that property", function () {
